...
std::string index_to_light_color_name(int index)
{
	switch (index)
	{
	...
	case (4): return "Mint"; break;
	case (5): return "Pink"; break;
	case (6): return "Orange"; break;
	case (7): return "Hot Pink"; break;
	case (8): return "White"; break;
	default: throw std::runtime_error("index_to_light_color: index out of range");
	}
}
...
std::string colliding_entity_type_to_name(COLLIDING_ENTITY_SUBTYPE subtype)
{
	...
	case (COLLIDING_ENTITY_SUBTYPE::VETERAN_CASTER): return "Veteran Caster";
	case (COLLIDING_ENTITY_SUBTYPE::ELEMENTAL): return "Elemental";
	case (COLLIDING_ENTITY_SUBTYPE::ELDER_ELEMENTAL): return "Elder Elemental";
...
std::string walking_entity_type_to_name(WALKING_ENTITY_SUBTYPE subtype)
{
	...
	case (WALKING_ENTITY_SUBTYPE::POWERFUL_WARRIOR): return "Powerful Warrior";
	case (WALKING_ENTITY_SUBTYPE::GOLEM): return "Golem";
	case (WALKING_ENTITY_SUBTYPE::RESISTANT_GOLEM): return "Resistant Golem";
...
int colliding_entity_value(COLLIDING_ENTITY_SUBTYPE subtype)
{
	...
	case (COLLIDING_ENTITY_SUBTYPE::VETERAN_CASTER): return 500;
	case (COLLIDING_ENTITY_SUBTYPE::ELEMENTAL): return 500;
	case (COLLIDING_ENTITY_SUBTYPE::ELDER_ELEMENTAL): return 500;
...
int walking_entity_value(WALKING_ENTITY_SUBTYPE subtype)
{
	...
	case (WALKING_ENTITY_SUBTYPE::POWERFUL_WARRIOR): return 100;
	case (WALKING_ENTITY_SUBTYPE::GOLEM): return 300;
	case (WALKING_ENTITY_SUBTYPE::RESISTANT_GOLEM): return 300;
