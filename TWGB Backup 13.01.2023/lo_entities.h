...
private:
	...
	inline static const float launch_interval = 1.f;
	inline static const unsigned int damage_stat = 4u;
...
class Caster_Base : public Colliding_Entity, public Bullet_Manager_Component, public Enemy_Component
{
private:
...
public:
	...
	Caster_Base(LEVEL_THEME theme_id, unsigned int health, unsigned int damage, int points);

	sf::FloatRect get_hitbox();

	void perform_update(Resources& resources, Player& player, const sf::Time& dt, bool shoot_ready,
		const hct::dynarray<std::unique_ptr<Solid_Tile>>& solid_tiles,
		const hct::dynarray<std::unique_ptr<Destructible_Tile>>& destructible_tiles);
	void draw(sf::RenderTexture& rt) const override;
...
class Caster final : public Caster_Base
{
private:
...
class Veteran_Caster final : public Caster_Base
{
private:

	inline static const float shoot_interval = 0.75f;
...
public:
	...
	Veteran_Caster(LEVEL_THEME theme_id);
...
class Elemental_Base : public Colliding_Entity, public Bullet_Manager_Component, public Enemy_Component
{
private:
...
public:
	...
	Elemental_Base(LEVEL_THEME theme_id, unsigned int health, unsigned int damage, int points, float shoot_countdown_time);

	sf::FloatRect get_hitbox();

	void perform_update(Resources& resources, Player& player, const sf::Time& dt, float speed,
		const hct::dynarray<std::unique_ptr<Solid_Tile>>& solid_tiles,
		const hct::dynarray<std::unique_ptr<Destructible_Tile>>& destructible_tiles);
	void draw(sf::RenderTexture& rt) const override;
...
class Elemental final : public Elemental_Base
{
private:

	inline static const float shoot_countdown = 0.4f;
...
class Elder_Elemental final : public Elemental_Base
{
private:

	inline static const float shoot_countdown = 0.3f;
	inline static const float speed_stat = 300.f;
	inline static const unsigned int health_stat = 24u;
	inline static const unsigned int damage_stat = 6u;
...
public:
	...
	Elder_Elemental(LEVEL_THEME theme_id);
...
private:
	...
	inline static const float shoot_interval = 0.5f;
	inline static const float shoot_break_time = 1.f;
	inline static const unsigned int health_stat = 32u;
	inline static const unsigned int damage_stat = 4u;
...
class Warrior_Base : public Walking_Entity, public Enemy_Component
{
private:
...
public:
	...
	Warrior_Base(LEVEL_THEME theme_id, unsigned int health, unsigned int damage, int points);
...
class Warrior : public Warrior_Base
{
private:

	inline static const float speed_stat = 360.f;
	inline static const unsigned int health_stat = 16u;
	inline static const unsigned int damage_stat = 4u;
...
class Powerful_Warrior : public Warrior_Base
{
private:

	inline static const float speed_stat = 400.f;
	inline static const unsigned int health_stat = 32u;
	inline static const unsigned int damage_stat = 8u;
...
public:
	...
	Powerful_Warrior(LEVEL_THEME theme_id);
...
class Golem_Base : public Walking_Entity, public Enemy_Component
{
private:
...
public:
	...
	Golem_Base(LEVEL_THEME theme_id, unsigned int health, unsigned int damage, int points);

	sf::FloatRect get_hitbox();

	void perform_update(Resources& resources, Player& player, const sf::Time& dt, float speed, unsigned int regeneration_value);
	void draw(sf::RenderTexture& rt) const override;

};

class Golem : public Golem_Base
{
private:
...
class Resistant_Golem : public Golem_Base
{
private:

	inline static const float speed_stat = 280.f;
	inline static const unsigned int health_stat = 80u;
	inline static const unsigned int damage_stat = 6u;
	inline static const unsigned int regeneration_stat = 8u;
...
public:
	...
	Resistant_Golem(LEVEL_THEME theme_id);
