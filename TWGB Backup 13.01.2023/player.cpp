...
float Player::get_visible_light() const
{
...
void Player::set_stats(Player_Data arg)
{
	set_max_health(arg.health);
	set_health(arg.health);
	set_damage(arg.damage);
}
...
void Player::set_visible_light(float arg)
{
	visible_light = arg;
}
