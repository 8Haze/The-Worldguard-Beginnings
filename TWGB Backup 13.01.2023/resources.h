...
class RM_Shaders : public Resource_Manager<RM_Shaders, RESOURCE_ID::SHADERS, sf::Shader, std::pair<std::string, std::string>>
{
private:

	friend class Resource_Manager<RM_Shaders, RESOURCE_ID::SHADERS, sf::Shader, std::pair<std::string, std::string>>;

	sf::Shader& load_resource(std::pair<std::string, std::string> files, RESOURCE_ID::SHADERS id);
