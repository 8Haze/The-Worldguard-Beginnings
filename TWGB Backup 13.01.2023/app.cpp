...
App::App(STATE arg_init_state = STATE::MAIN_MENU)
{
	...
	factories.emplace(STATE::LEVEL_CREATOR_OBJECT_SELECTION_LIGHT, State_LCOS_Light::make_state);
	...
	factories.emplace(STATE::CHARACTER_PANEL, State_Character_Panel::make_state);
	factories.emplace(STATE::AUTO_UPGRADE, State_Auto_Upgrade::make_state);
