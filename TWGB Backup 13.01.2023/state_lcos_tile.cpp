...
INTERACTIVE_TILE_SUBTYPE State_LCOS_Interactive_Tile::transform_index(int index)
{
	...
	case (7): return INTERACTIVE_TILE_SUBTYPE::DARK;
	case (8): return INTERACTIVE_TILE_SUBTYPE::LIGHT;
	...
	case (12): return INTERACTIVE_TILE_SUBTYPE::CONVEYOR_BELT;
	case (13): return INTERACTIVE_TILE_SUBTYPE::CONVEYOR_BELT;
	case (14): return INTERACTIVE_TILE_SUBTYPE::ANTI_GRAVITY;
...
void State_LCOS_Interactive_Tile::update(const sf::Time& dt)
{
	...
	if (auto pos = sf::Mouse::getPosition(); options.getGlobalBounds().contains(pos.x, pos.y))
	{
		...
		case (12): info.setString(info.getString() + " (moving left)"); break;
		case (13): info.setString(info.getString() + " (moving right)"); break;
		}
