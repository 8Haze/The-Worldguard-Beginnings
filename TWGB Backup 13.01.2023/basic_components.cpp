...
Health_Component::Health_Component(unsigned int health_) : health(health_), max_health(health_) {}
...
Damage_Component::Damage_Component(unsigned int damage_) : damage(damage_) {}
...
Value_Component::Value_Component(int value_) : value(value_) {}
