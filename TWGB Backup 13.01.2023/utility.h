...
const int CAMPAIGN_LEVELS_COUNT = 8; // increase when more levels are added, 64 is the goal obv
const int PLAYER_PROXIMITY_DISTANCE = 32 * 2;
const int COLLIDING_ENTITY_RENDER_DISTANCE = 32 * 40;
...
struct Player_Data
{
	...
	unsigned int cells_balance = 0;
	unsigned int total_cells = 0;
	unsigned int health = 0;
	unsigned int damage = 0;
	unsigned int cells_for_next_upgrade = 0;
};
