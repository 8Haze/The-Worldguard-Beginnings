...
Ice_Chunk::Ice_Chunk(Resources& arg_resources, sf::Vector2f arg_position, DIRECTION arg_direction) : Vertical_Physics_Component(*this), Horizontal_Physics_Component(*this)
{
