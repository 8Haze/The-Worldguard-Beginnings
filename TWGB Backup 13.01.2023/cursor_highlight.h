// a sprite that needs origin coords and offset (32)
// has a static member that tells us about transparency value
// has a draw_at function that takes mouse coords and fixes them by the offset
