...
std::string State_LCOS_Entity::option_to_string(OPTION option)
{
	...
	case (OPTION::POWERFUL_WARRIOR): return walking_entity_type_to_name(WALKING_ENTITY_SUBTYPE::POWERFUL_WARRIOR);
	case (OPTION::CASTER): return colliding_entity_type_to_name(COLLIDING_ENTITY_SUBTYPE::CASTER);
	case (OPTION::VETERAN_CASTER): return colliding_entity_type_to_name(COLLIDING_ENTITY_SUBTYPE::VETERAN_CASTER);
	case (OPTION::ELEMENTAL): return colliding_entity_type_to_name(COLLIDING_ENTITY_SUBTYPE::ELEMENTAL);
	case (OPTION::ELDER_ELEMENTAL): return colliding_entity_type_to_name(COLLIDING_ENTITY_SUBTYPE::ELDER_ELEMENTAL);
	case (OPTION::GOLEM): return walking_entity_type_to_name(WALKING_ENTITY_SUBTYPE::GOLEM);
	case (OPTION::RESISTANT_GOLEM): return walking_entity_type_to_name(WALKING_ENTITY_SUBTYPE::RESISTANT_GOLEM);
	...
	if (event.type == sf::Event::MouseButtonPressed && event.key.code == sf::Mouse::Left)
		if (auto pos = sf::Mouse::getPosition(); options.getGlobalBounds().contains(pos.x, pos.y))
		{
			...
			case (OPTION::WARRIOR):
				...
				break;
			case (OPTION::POWERFUL_WARRIOR):
				app_handle.register_scpp(std::make_unique<SCPP_LCOS_Walking_Entity>(WALKING_ENTITY_SUBTYPE::POWERFUL_WARRIOR, 48));
				break;
			case (OPTION::CASTER):
				app_handle.register_scpp(std::make_unique<SCPP_LCOS_Colliding_Entity>(COLLIDING_ENTITY_SUBTYPE::CASTER, 48));
				break;
			case (OPTION::VETERAN_CASTER):
				app_handle.register_scpp(std::make_unique<SCPP_LCOS_Colliding_Entity>(COLLIDING_ENTITY_SUBTYPE::VETERAN_CASTER, 48));
				break;
			case (OPTION::ELEMENTAL):
				...
				break;
			case (OPTION::ELDER_ELEMENTAL):
				app_handle.register_scpp(std::make_unique<SCPP_LCOS_Colliding_Entity>(COLLIDING_ENTITY_SUBTYPE::ELDER_ELEMENTAL, 32));
				break;
			case (OPTION::GOLEM):
				app_handle.register_scpp(std::make_unique<SCPP_LCOS_Walking_Entity>(WALKING_ENTITY_SUBTYPE::GOLEM, 48));
				break;
			case (OPTION::RESISTANT_GOLEM):
				app_handle.register_scpp(std::make_unique<SCPP_LCOS_Walking_Entity>(WALKING_ENTITY_SUBTYPE::RESISTANT_GOLEM, 48));
				break;
